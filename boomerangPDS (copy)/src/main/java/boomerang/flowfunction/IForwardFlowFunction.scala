...
trait IForwardFlowFunction {
   ...
   *         method callee
   */
  def callFlow(callSite: Nothing, factAtCallSite: Nothing, callee: Nothing): Nothing
   ...
   *         Node<Edge,Val>).
   */
  def normalFlow(query: Nothing, edge: Nothing, fact: Nothing): Nothing
   ...
   *         Node<Edge,Val>)
   */
  def callToReturnFlow(query: Nothing, edge: Nothing, fact: Nothing): Nothing
